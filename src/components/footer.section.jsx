    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">🏠 EstatePro</h3>
            <p className="text-gray-400 text-sm">
              Discover verified properties with 0% commission listings. Your trusted real estate partner.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Investment Deals</a></li>
            </ul>
          </div>
